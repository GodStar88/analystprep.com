...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__login_component__ = __webpack_require__(964);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__login_component__ = __webpack_require__(964);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__login_routing__ = __webpack_require__(1059);
    ...
    Login.prototype.onFacebooklogin = function () {
        ...
        this.userService.facebook(this.user)
            ...
            if (res.success) {
                ...
                _this.user.name = res.data.username;
                _this.user.photo = res.data.image;
